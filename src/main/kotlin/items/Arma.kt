...
class Arma(val nombre:String, val arquetipo:String, val tipoArma:String, val elemento: Elementos, val rareza :String,private var rarity:TextColors, val colorElemento:TextColors): Equipable<List<Arma>>, Item(){
